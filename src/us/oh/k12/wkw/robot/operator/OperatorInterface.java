...
public class OperatorInterface {
	...
	private void setupInternalButtons() {
		...
		try {
			...
			// SmartDashboard.putData("Camera Pan Left Button",
			// this.cameraPanLeftButton);
			// this.cameraPanLeftButton.whenPressed(new
			// CameraPanByCmd(-2.000000));

			this.cameraPanRightButton = new InternalButton();
			// SmartDashboard.putData("Camera Pan Right Button",
			// this.cameraPanRightButton);
			// this.cameraPanRightButton.whenPressed(new
			// CameraPanByCmd(2.000000));

			this.cameraTiltUpButton = new InternalButton();
			// SmartDashboard.putData("Camera Tilt Up Button",
			// this.cameraTiltUpButton);
			// this.cameraTiltUpButton.whenPressed(new
			// CameraTiltByCmd(2.000000));

			this.cameraTiltDownButton = new InternalButton();
			// SmartDashboard.putData("Camera Tilt Down Button",
			// this.cameraTiltDownButton);
			// this.cameraTiltDownButton.whenPressed(new
			// CameraTiltByCmd(-2.000000));
			...
			// this.cameraRotateForwardButton.whenPressed(new
			// CameraRotateToShooter());
			...
			// this.cameraRotateBackwardButton.whenPressed(new
			// CameraRotateToGatherer());

			this.shooterMotorTurnOnButton = new InternalButton();
			// SmartDashboard.putData("Shooter Motor Turn On Button",
			// this.shooterMotorTurnOnButton);
			// this.shooterMotorTurnOnButton.whenPressed(new
			// ShooterTurnMotorOnCmd());

			this.shooterMotorTurnOffButton = new InternalButton();
			// SmartDashboard.putData("Shooter Motor Turn Off Button",
			// this.shooterMotorTurnOffButton);
			// this.shooterMotorTurnOffButton.whenPressed(new
			// ShooterTurnMotorOffCmd());

			this.gathererMotorTurnOnButton = new InternalButton();
			// SmartDashboard.putData("Gatherer Motor Turn On Button",
			// this.gathererMotorTurnOnButton);
			// this.gathererMotorTurnOnButton.whenPressed(new
			// GathererTurnOnCmd());
			...
			// this.gathererMotorTurnOffButton.whenPressed(new
			// GathererTurnOffCmd());
			...
			// this.shooterPlungerTurnOnButton.whenPressed(new
			// ShooterStartPlungerMotorCmd());
			...
			// this.shooterPlungerTurnOffButton.whenPressed(new
			// ShooterStopPlungerMotorCmd());
			...
			// this.beachingMotorExtendButton.whenPressed(new
			// BeachingStartMotorCmd(true));
			...
			// this.beachingMotorRetractButton.whenPressed(new
			// BeachingStartMotorCmd(false));
			...
			// this.beachingMotorTurnOffButton.whenPressed(new
	...
	private void setupGamepad() {
		...
		try {
			...
			this.debug("setupGamepad()",
					"shooterControler=" + WkwPrefs.getGamepadPort() + ".");
			...
			if (null != this.shooterControler) {
				...
				this.debug("setupGamepad()",
						"Right button 5=Shoot motor toggle");
				// new JoystickButton(this.shooterControler, 5)
				// .whenPressed(new ShooterMotorToggleCmd());

				this.debug("setupGamepad()",
						"Right button 6=ShooterShootBallCmd.");
				// new JoystickButton(this.shooterControler, 6).whenPressed(new
				// ShooterShootBallCmd());

				this.debug("setupGamepad()",
						"Right button 7=ShooterDecreaseMotorSpeedByCmd.");
				// new JoystickButton(this.shooterControler, 7)
				// .whenPressed(new ShooterDecreaseMotorSpeedByCmd(0.010000));

				this.debug("setupGamepad()",
						"Right button 8=ShooterIncreaseMotorSpeedByCmd.");
	...
	private void setupRightJoystick() {
		...
		try {
			...
			this.debug("setupRightJoystick()",
					"rightJoystick=" + WkwPrefs.getJoystickRightPort() + ".");
			...
			if (null != this.rightJoystick) {
				...
				this.debug("setupRightJoystick()",
						"Right trigger=BeachingExtendCmd.");
				// new JoystickButton(this.rightJoystick, 1).whenPressed(new
				// BeachingExtendCmd());

				this.debug("setupRightJoystick",
						"Right button 2=CameraRotateToGatherer.");
				// new JoystickButton(this.rightJoystick, 2).whenPressed(new
				// CameraRotateToGatherer());
				...
				this.debug("setupRightJoystick()",
						"Right button 4=GathererBackwardCmd +.");
				// new JoystickButton(this.rightJoystick, 4).whenPressed(new
				// GathererBackwardCmd());

				this.debug("setupRightJoystick()",
						"Right button 5=BeachingStopMotorCmd +.");
				// new JoystickButton(this.rightJoystick, 5).whenPressed(new
				// BeachingStopMotorCmd());

				this.debug("setupRightJoystick()",
						"Right button 6=CameraPanByCmd +.");
				// new JoystickButton(this.rightJoystick, 6).whenPressed(new
				// CameraPanByCmd(1));

				this.debug("setupRightJoystick()",
						"Right button 7=CameraPanByCmd -.");
				// new JoystickButton(this.rightJoystick, 7).whenPressed(new
				// CameraPanByCmd(-1));

				this.debug("setupRightJoystick()",
						"Right button 8=RobotInitializeCmd.");
				// new JoystickButton(this.rightJoystick, 8).whenPressed(new
				// RobotInitializeCmd());

				this.debug("setupRightJoystick()",
						"Right button 9=ShooterFirePlungerCmd.");
				// new JoystickButton(this.rightJoystick, 9).whenPressed(new
				// ShooterFirePlungerCmd());

				this.debug("setupRightJoystick()",
						"Right button 10=CameraTiltByCmd -.");
				// new JoystickButton(this.rightJoystick, 10).whenPressed(new
				// CameraTiltByCmd(-1));

				this.debug("setupRightJoystick()",
						"Right button 11=CameraTiltByCmd +.");
				// new JoystickButton(this.rightJoystick, 11).whenPressed(new
				// CameraTiltByCmd(1));
	...
	private void setupLeftJoystick() {
		...
		try {
			...
			this.debug("setupLeftJoystick()",
					"leftJoystick=" + WkwPrefs.getJoystickLeftPort() + ".");
